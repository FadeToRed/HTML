...
function costruisciImmagini() { 
 return inputText('campo-img-laterale','Immagine Header (URL) — dimensioni ideali: 664x184px. Immagini di dimensioni diverse verranno ridimensionate automaticamente.','https://...') + 
  inputText('campo-img-dati','Immagine slide Dati (URL) — dimensioni ideali: 154x429px. Immagini di dimensioni diverse verranno ridimensionate automaticamente.','https://...') + 
  inputText('campo-img-info','Immagine slide Dati (URL) — dimensioni ideali: 154x429px. Immagini di dimensioni diverse verranno ridimensionate automaticamente.','https://...') + 
  inputText('campo-img-abilita','Immagine slide Abilità (URL) — dimensioni ideali: 117x487px. Immagini di dimensioni diverse verranno ridimensionate automaticamente.','https://...'); 
} 
